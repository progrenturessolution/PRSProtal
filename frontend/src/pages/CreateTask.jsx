      ...
      <div className="card">
        <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <div style={{
                ...
                {filteredInterns.length === 0 ? (
                  <div style={{ 
                    ...
                    {searchQuery ? 'No interns found matching your search' : 'No interns available'}
                  </div>
                ) : (
                  filteredInterns.map((intern) => (
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: formData.assignedTo === intern._id ? '#dbeafe' : 'transparent'
                      }}
                      onMouseEnter={(e) => {
              ...
              {formData.assignedTo && !searchQuery && (
                <div style={{
                  ...
                  ✓ Selected: {interns.find(i => i._id === formData.assignedTo)?.name}
                </div>
              )}
                  ...
                  filteredInterns.map((intern) => (
                    <label
                      ...
                      style={{
                        ...
                        cursor: 'pointer',
                        transition: 'background-color 0.2s',
                        backgroundColor: selectedTeamMembers.includes(intern._id) ? '#dbeafe' : 'transparent'
                      }}
                      onMouseEnter={(e) => {
          ...
          <button 
            ...
            disabled={loading}
          >
            {loading ? 'Creating Task...' : assignmentType === 'team' ? `Assign to ${selectedTeamMembers.length} Team Members` : 'Create & Assign Task'}
          </button>
        </form>
      </div>
    </>
