        ...
        {filteredStudents.length === 0 ? (
          <div style={{
            ...
            <p style={{ fontSize: '18px', fontWeight: 500 }}>
              {searchQuery ? 'No students found matching your search' : 'No archived students'}
            </p>
          </div>
        ) : (
                  ...
                  <tr key={student._id}>
                    ...
                    <td>
                      <span style={{
                        ...
                        fontSize: '12px',
                        fontWeight: '600',
                        backgroundColor: student.studentType === 'Internship' ? '#dbeafe' : '#e0e7ff',
                        color: student.studentType === 'Internship' ? '#1e40af' : '#4338ca'
                      }}>
                        {student.studentType}
                      </span>
                    </td>
        ...
        <div className="modal-overlay" onClick={() => setConfirmRestore(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '500px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              ...
              <h3 style={{ fontSize: '20px', fontWeight: 'bold', margin: 0 }}>Restore Student?</h3>
            </div>
            <p style={{ color: '#64748b', marginBottom: '24px', lineHeight: '1.6' }}>
              Are you sure you want to restore <strong style={{ color: '#0f172a' }}>{confirmRestore.name}</strong>?
              This will move the student back to the active students list.
            </p>
            <div style={{ display: 'flex', gap: '12px' }}>
              <button
                onClick={() => handleRestore(confirmRestore._id, confirmRestore.name)}
                style={{
                  flex: 1,
                  padding: '12px',
                  backgroundColor: '#10b981',
        ...
        <div className="modal-overlay" onClick={() => setConfirmDelete(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '500px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              ...
              <h3 style={{ fontSize: '20px', fontWeight: 'bold', margin: 0, color: '#dc2626' }}>Permanent Delete?</h3>
            </div>
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{
                ...
                <p style={{ color: '#dc2626', fontWeight: '600', marginBottom: '8px' }}>⚠️ WARNING: This action is IRREVERSIBLE!</p>
                <p style={{ color: '#475569', fontSize: '14px', lineHeight: '1.5', margin: 0 }}>
                  All data including profile information, certificates, documents, and task history 
                  will be permanently deleted from the database and cannot be recovered.
                </p>
              </div>
            </div>
            <div style={{ display: 'flex', gap: '12px' }}>
              <button
                onClick={() => handlePermanentDelete(confirmDelete._id, confirmDelete.name)}
                style={{
                  flex: 1,
                  padding: '12px',
