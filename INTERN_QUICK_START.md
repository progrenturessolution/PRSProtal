...
Credentials:
- Intern ID: PRG20240001 (or your assigned ID)
...
❌ **Cannot skip approval**: When you reach 100%, task goes to "Pending Approval". Only admin can mark it complete.

❌ **Cannot change pending tasks**: Once submitted (100%), you cannot change progress until admin responds.

❌ **Cannot update completed tasks**: Once admin approves, task is locked.
...
2. **Be accurate**: If you're at 25%, don't mark 75%. Admin can see your progress.

3. **Submit on time**: Try to submit before deadline to give admin time to review.

4. **Check daily**: Login daily to see new tasks or status updates.

5. **Ask questions**: If task is unclear, ask admin before starting.
