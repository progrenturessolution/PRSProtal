...
async function run() {
  const mongoURI = process.env.MONGO_URI || process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/prs_portal";
  ...
  console.log("Found student ID (as string):", userId, typeof userId);
  ...
  console.log("Matching notifications after update readBy details:");
  matchingNotesAfter.forEach(n => {
    console.log(`Notification: ${n.title}, readBy:`, JSON.stringify(n.readBy));
  });
